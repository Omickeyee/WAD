...
const db_connection = "mongodb+srv://admin:admin@cluster0.79gplwb.mongodb.net/MUSIC?retryWrites=true&w=majority"
const port = 2324
...
app.get("/displayCountAndDocuments", async function (request, response) {
    ...
    let html = '<table>'
        songs.map(function(stu) {
            html = html+'<tr>'
            html = html+'<td>'+stu.Songname+'</td>'
            html = html+'</tr>'
